      ...
      <div className="row between">
        <div className="column left">
          ...
          <div className="row middle misc">
            <Code code="npm i beast-grid" language={'bash'} canCopy style={{ width: 190}} />
            <Button
              variant="outlined"
        ...
        <div className="logo-container row middle center">
          ...
          <Image src="/beast.png" alt="Beast Grid" width={LOGO_SIZE} height={LOGO_SIZE} />
        </div>
      </div>
